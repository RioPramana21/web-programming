    ...
    <div class="row justify-content-center">
        <div class="col-lg-5">
            <main class="form-registration w-100 m-auto">
                <h1 class="h3 mb-3 fw-normal text-center">@lang('public.registration form')</h1>
                <form action="/register" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-floating">
                        <input type="text" name="first_name"
                            ...
                            placeholder="Name" required value="{{ old('first_name') }}" autofocus>
                    ...
                    <div class="mb-3 mt-3">
                        <label for="role_id" class="fw-bold">@lang('public.role'):
                            <select id="role_id" name="role_id" class="form-control @error('role_id') is-invalid @enderror" >
                                ...
                                <option value=2>@lang('public.user')</option>
                            </select>
                        </label>
                        @error('role_id')
                            <div class="invalid-feedback">
                    ...
                    <button class="w-100 btn btn-lg btn-primary mt-4" type="submit">@lang('public.register')</button>

                </form>

                <small class="d-block text-center mt-3"><a href="/login">@lang('public.already have an account?')</a></small>
            </main>
        </div>
    </div>
